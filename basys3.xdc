...
set_property PACKAGE_PIN V19 [get_ports {speaker_led}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {speaker_led}]
...
set_property PACKAGE_PIN P1 [get_ports {set_alarm_led}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_alarm_led}]
set_property PACKAGE_PIN L1 [get_ports {change_time_led}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {change_time_led}]
...
Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {speaker}]				
